...
#define STRING_DISTRIBUTION_DATE "2019-06-14"
...
#define CUSTOM_MACHINE_NAME "3D PrinTaGuel"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "d713b314-faf2-4905-ac46-50e204039f0e"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // ANET A8 E3DV6 24V Extruder at 190 °C
  //(measured after M106 S255 with M303 E0 S190 C10 U)
  #define DEFAULT_Kp 23.59
  #define DEFAULT_Ki 1.85
  #define DEFAULT_Kd 75.09
#endif // PIDTEMP
 ...
 */
#define MAX_BED_POWER 168 // limits duty cycle to bed; 255=full current
  ...
  // FIND YOUR OWN: "M303 E-1 C8 S90" to run autotune on the bed at 90 degreesC for 10 cycles.
  // A8 24V + MAX_BED_POWER 168 + 3mm borosilicate + protection thermique sous le bed
  #define DEFAULT_bedKp 76.39
  #define DEFAULT_bedKi 10.04
  #define DEFAULT_bedKd 145.29
#endif // PIDTEMPBED
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { X_St_per_U, Y_St_per_U, Z_St_per_U, E0_St_per_U}
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
 #define DEFAULT_MAX_FEEDRATE          { 400, 400, 10, 50} // Dual Z
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_BRIGHTNESS 168  // Initial brightness (0-255)
  #define NEOPIXEL_STARTUP_TEST  // Cycle through colors at startup

  // Use a single Neopixel LED for static (background) lighting
  #define NEOPIXEL_BKGD_LED_INDEX  0               // Index of the LED to use
  #define NEOPIXEL_BKGD_COLOR { 0, 255, 255, 255 } // R, G, B, W
#endif
